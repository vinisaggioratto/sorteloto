let baseUrl3 = "https://loteriascaixa-api.herokuapp.com/api/duplasena/latest"
/**/
/**/
function exibirResultadoDuplaSenaResumido() {
  ...
  `;
        ...
        for (let i = 0; i < arrayOrigin.length; i++) {
            ...
            array += '<span class="configNumberResultados" style="border-color:#A61324;">' + arrayOrigin[i] + '</span>'
        }
        tab2 +=
            `
...
`;
  ...
  `;
      ...
      `;
            ...
            document.getElementById("bodytabelaDuplaSena").innerHTML = tab;
            document.getElementById("bodytabelaDuplaSena").innerHTML += tab2;
            document.getElementById("bodytabelaDuplaSena").innerHTML += tab3;
            document.getElementById("bodytabelaDuplaSena").innerHTML += tab4;
        })
...
function exibirResultadoDuplaSena() {
    resultado = document.getElementById('exibirResultado')
    let acumulado = 'Não'
    axios.get(baseUrl3)
        .then(function (response) {
