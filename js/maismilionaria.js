let baseUrl6 = "https://loteriascaixa-api.herokuapp.com/api/maismilionaria/latest"
/**/
/**/
function exibirResultadoMaisMilionariaResumido() {
  ...
  `;
        ...
        for (let i = 0; i < arrayOrigin.length; i++) {
            ...
            array += '<span class="configNumberResultados" style="border-color:#2E3078;">' + arrayOrigin[i] + '</span>'
        }
        tab2 +=
            `
...
`;
  ...
  `;
      ...
      `;
            ...
            document.getElementById("bodytabelaMilionaria").innerHTML = tab;
            document.getElementById("bodytabelaMilionaria").innerHTML += tab2;
            document.getElementById("bodytabelaMilionaria").innerHTML += tab3;
            document.getElementById("bodytabelaMilionaria").innerHTML += tab4;
        })
...
function exibirResultadoMaisMilionaria() {
    resultado = document.getElementById('exibirResultado')
    let acumulado = 'Não'
    axios.get(baseUrl6)
        .then(function (response) {
